    ...
    <div className="auth-wrap">
      ...
      <div className="auth-card">
        <div className="auth-tabs">
          <div className={`auth-tab ${tab === 'login' ? 'on' : ''}`}    onClick={() => { setTab('login');    setError('') }}>Log In</div>
          <div className={`auth-tab ${tab === 'register' ? 'on' : ''}`} onClick={() => { setTab('register'); setError('') }}>Register</div>
        </div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button
                ...
                style={{
                  ...
                  color: 'var(--gray)', padding: 4, lineHeight: 1,
                }}
              >
                {showPw ? '🙈' : '👁'}
              </button>
